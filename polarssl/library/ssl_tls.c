...
int ssl_derive_keys( ssl_context *ssl )
{
...
#if !defined(POLARSSL_EDH_ONLY)
             session->ciphersuite == TLS_RSA_WITH_AES_256_GCM_SHA384 ||
#endif
    ...
    switch( session->ciphersuite )
    {
        ...
        case TLS_DHE_RSA_WITH_AES_128_CBC_SHA:
            ...
            break;
#endif /* defined(POLARSSL_AES_128) */

#if defined(POLARSSL_AES_256)
#if !defined(POLARSSL_EDH_ONLY)
        ...
        case TLS_DHE_RSA_WITH_AES_256_CBC_SHA:
            ...
            transform->ivlen  = 16; transform->maclen = 20;
            break;
#endif /* defined(POLARSSL_AES_256) */
        ...
        case TLS_RSA_WITH_NULL_SHA256:
            ...
            break;
#endif /* !defined(POLARSSL_EDH_ONLY) */
...
#if !defined(POLARSSL_EDH_ONLY)
#if defined(POLARSSL_AES_128)
            ssl->session_out->ciphersuite == TLS_RSA_WITH_AES_128_GCM_SHA256 ||
#endif
#if defined(POLARSSL_AES_256)
    ...
    else
    {
        ...
        switch( ssl->transform_out->ivlen )
        {
            ...
            case  8:
                ...
                if( 
#if !defined(POLARSSL_EDH_ONLY)
                    ssl->session_out->ciphersuite == TLS_RSA_WITH_DES_CBC_SHA ||
#endif
...
#if !defined(POLARSSL_EDH_ONLY)
#if defined(POLARSSL_AES_128)
             ssl->session_out->ciphersuite == TLS_RSA_WITH_AES_128_CBC_SHA ||
#endif
#if defined(POLARSSL_AES_256)
        ...
        if ( 
#if !defined(POLARSSL_EDH_ONLY)
             ssl->session_out->ciphersuite == TLS_RSA_WITH_CAMELLIA_128_CBC_SHA ||
...
#if !defined(POLARSSL_EDH_ONLY)
#if defined(POLARSSL_AES_128)
            ssl->session_in->ciphersuite == TLS_RSA_WITH_AES_128_GCM_SHA256 ||
#endif
#if defined(POLARSSL_AES_256)
    ...
    else
    {
        ...
        switch( ssl->transform_in->ivlen )
        {
            ...
            case  8:
                ...
                if( 
#if !defined(POLARSSL_EDH_ONLY)
                    ssl->session_in->ciphersuite == TLS_RSA_WITH_DES_CBC_SHA ||
#endif
            ...
            case 16:
#if defined(POLARSSL_AES_C) && (defined(POLARSSL_AES_128) || defined(POLARSSL_AES_256))
        if ( 
#if !defined(POLARSSL_EDH_ONLY)
#if defined(POLARSSL_AES_128)
             ssl->session_in->ciphersuite == TLS_RSA_WITH_AES_128_CBC_SHA ||
#endif
#if defined(POLARSSL_AES_256)
        ...
        if ( 
#if !defined(POLARSSL_EDH_ONLY)
             ssl->session_in->ciphersuite == TLS_RSA_WITH_CAMELLIA_128_CBC_SHA ||
...
int ssl_set_dh_param( ssl_context *ssl, const char *dhm_P, const char *dhm_G )
{
    ...
    param_size = mpi_size(&ssl->dhm_P) * 8;

    if ( param_size < POLARSSL_DHM_MIN_SIZE || param_size > POLARSSL_DHM_MAX_SIZE )
    {
        SSL_DEBUG_MSG(1, ("Invalid DH parameter length"));
        return POLARSSL_ERR_SSL_BAD_DHM_SIZE;
    }
...
{
    int ret;
    size_t param_size = mpi_size(&dhm_ctx->P) * 8;
...
{
#if defined(POLARSSL_DHM_C)
#if defined(POLARSSL_AES_C) && defined(POLARSSL_AES_256)
#if defined(POLARSSL_GCM_C) && defined(POLARSSL_SHA4_C)
...
#endif /* defined(POLARSSL_AES_C) && defined(POLARSSL_AES_256) */
#if defined(POLARSSL_AES_C) && defined(POLARSSL_AES_128)
#if defined(POLARSSL_GCM_C) && defined(POLARSSL_SHA2_C)
...
#endif /* defined(POLARSSL_AES_C) && defined(POLARSSL_AES_128) */
#if defined(POLARSSL_CAMELLIA_C)
#if defined(POLARSSL_SHA2_C)
