...
int aes_self_test( int verbose )
{
    ...
    size_t offset;
#endif
#if defined(POLARSSL_CIPHER_MODE_CTR) && defined (POLARSSL_AES_128)
    int len;
    unsigned char nonce_counter[16];
    unsigned char stream_block[16];
#endif
...
#ifndef POLARSSL_AES_128
        if (u == 0 ) continue;
#endif
#ifndef POLARSSL_AES_192
        if (u == 1 ) continue;
#endif
#ifndef POLARSSL_AES_256
        if (u == 2 ) continue;
#endif
