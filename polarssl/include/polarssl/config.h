...
/*
 * Hardening: disable individual AES key lengths at compile time
 */
#define POLARSSL_AES_256
//#define POLARSSL_AES_192
//#define POLARSSL_AES_128
 ...
 * Module:  library/des.c
 *
 * This module enables the DES crypto functions, without adding a ciphersuite.
 */
#define POLARSSL_DES_CRYPTO_ONLY
...
/**
 * \def POLARSSL_DHM_MIN_SIZE
 *
 * The minimum allowed size of the DHM parameters
 *
 * Module:  library/dhm.c
 */
#define POLARSSL_DHM_MIN_SIZE 2048

/**
 * \def POLARSSL_DHM_MAX_SIZE
 *
 * The maximum allowed size of the DHM parameters
 *
 * Module:  library/dhm.c
 */
#define POLARSSL_DHM_MAX_SIZE 2048

/**
 * \def POLARSSL_EDH_ONLY
 *
 * The maximum size of the DHM parameters
 *
 * Module:  library/dhm.c
 */
#define POLARSSL_EDH_ONLY
...
/**
 * \def POLARSSL_RSA_MIN_KEY_SIZE
 *
 * The minimum allowed size of RSA keys
 *
 * Module:  library/rsa.c
 */
#define POLARSSL_RSA_MIN_KEY_SIZE 1024

/**
 * \def POLARSSL_RSA_MAX_KEY_SIZE
 *
 * The maximum allowed size of RSA keys
 *
 * Module:  library/rsa.c
 */
#define POLARSSL_RSA_MAX_KEY_SIZE 4096
