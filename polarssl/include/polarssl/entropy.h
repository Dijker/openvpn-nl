...
/**
 * \brief           Check if the threshold levels of the entropy sources have been reached.
 *
 * \param ctx       Entropy context
 *
 * \return          The number of source the threshold has not been reached for.
 */
int entropy_threshold_check( entropy_context *ctx );
