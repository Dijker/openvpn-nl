...
/**
 * Minimum number of bytes of entropy that should have been gathered from
 * the platform source (/dev/random) on CTR_DRBG reseed.
 */
#define FOX_ENTROPY_MIN_PLATFORM 16
...
/**
 * Initialize the platform entropy source in the random number generator.
 *
 * \param min_size 	The minimum number of entropy bytes required before
 *                      entropy can be retrieved.
 */
