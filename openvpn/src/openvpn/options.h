...
#endif
#ifndef ENABLE_SSL
# error "Compiling without ENABLE_SSL is not supported."
#endif
...
/*
 * Minimum uptime in seconds to allow /dev/urandom to be used. 
 * Using urandom directly after boot is unsafe.
 */
#define MIN_URANDOM_UPTIME 180
